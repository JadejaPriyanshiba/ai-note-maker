...
export const SettingsView: React.FC = () => {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 space-y-6">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-6 space-y-4 shadow-sm">
        ...
        <div className="space-y-3">
          <label className={`p-4 rounded-xl border flex items-start space-x-3 cursor-pointer transition-all ${
            mode === "default"
              ? "bg-indigo-50/60 dark:bg-indigo-950/40 border-indigo-500 ring-2 ring-indigo-500/10"
          ...
          <div className="pt-2 space-y-3">
            ...
            <div className="flex items-center space-x-2">
              <input
                ...
                placeholder="AIzaSy..."
                className="flex-1 p-2.5 rounded-xl border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-white text-xs font-mono focus:ring-2 focus:ring-indigo-500"
              />
              <button
                type="button"
                onClick={handleTestKey}
                disabled={isTesting || !apiKeyInput.trim()}
                className="px-4 py-2.5 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 text-xs font-semibold hover:bg-slate-200 border border-slate-300 dark:border-slate-700 disabled:opacity-50 flex items-center space-x-1"
              >
            ...
            <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/60 text-xs text-slate-600 dark:text-slate-400 flex items-center space-x-2">
      ...
      {/* Usage Stats Card */}
      <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-6 space-y-2 shadow-sm">
        <h3 className="text-sm font-bold text-slate-900 dark:text-white flex items-center space-x-2">
        ...
        {user ? (
          <>
            <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700/60 text-xs">
              ...
              <p className="text-[10px] text-slate-400 font-mono mt-0.5" title="Compare this exact ID on your other device">
                Account ID: {user.uid}
              </p>
            </div>
            ...
            <button
              ...
              disabled={syncing}
              className="px-4 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-semibold text-xs flex items-center space-x-2 shadow-sm transition-colors disabled:opacity-50"
            >
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl border border-red-200 dark:border-red-900/50 p-6 space-y-3 shadow-sm">
        <h3 className="text-sm font-bold text-slate-900 dark:text-white flex items-center space-x-2 text-red-600 dark:text-red-400">
